...
package object geometry {
  ...
  /** Implicit conversions for [[common.geometry.Vector2D]] instances
    *
    * {{{
    * val v = (1, 2) >> (3, 4)
    * }}}
  ...
  /** Implicit conversion to convert [[common.geometry.Vector3D]] instances
    *
    * {{{
    * val v = (1, 2, 1) >> (3, 4, 1)
    * }}}
  ...
  /** Implicit conversions from [[common.geometry.Vector2D]] to [[common.geometry.Vector3D]] and vice versa. */
