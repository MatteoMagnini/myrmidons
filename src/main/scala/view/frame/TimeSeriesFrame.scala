...
object TimeSeriesFrame {
  ...
  def apply(history: Map[Int, (Int, Int, Int, Int)]): TimeSeriesFrame = new TimeSeriesFrameImpl(history)
   ...
   */
  private[view] class TimeSeriesFrameImpl(override val history: Map[Int, (Int, Int, Int, Int)])
